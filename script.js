...
const PROJECTS = [
  ...
  // ── ПРОЕКТ 0 ── FINCORP ──────────────────────────────────
  {
    ...
    context:  'FINCORP — FINCORP — цифровой финансовый продукт с AI-помощником, который помогает пользователям принимать более осознанные финансовые решения, а не только совершать банковские операции.',

...
const PROJECTS = [
  ...
  // ── ПРОЕКТ 9 ── Т-Банк: Беспилотное Т-Такси (тестовое задание) ──
  {
    ...
    designSystem: 'Для сервиса собрала тёмную UI-палитру, привычную для операционных дашбордов: карточки инцидентов и машин, бейджи критичности (красный / оранжевый / жёлтый) и статуса, таблицы с сортировкой и фильтрами, модальные окна подтверждения действий и карту с локацией машины. Все компоненты используют единую логику критичности и статусов, чтобы инженер считывал состояние системы за секунды.',

...
const PROJECTS = [
  ...
  // ── ПРОЕКТ 5 ── Электронное меню «Панорама Лаундж» ───────
  {
    ...
    context: 'Электронное меню для ресторана «Панорама Лаундж» в Доброграде — цифровой продукт, который заменяет статичное бумажное меню на планшете, с инструментами управления для владельца.',
